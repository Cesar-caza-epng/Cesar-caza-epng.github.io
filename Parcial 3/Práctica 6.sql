...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2024 a las 04:37:47
...
INSERT INTO `artista` (`id`, `Nombre`, `descp`) VALUES
(1, 'ABBA', 'ABBA es un grupo sueco de música pop, integrado por Agnetha Fältskog, Björn Ulvaeus, Benny Andersson y Anni-Frid «Frida» Lyngstad. El nombre «ABBA» es un acrónimo formado por las primeras letras del nombre de cada'),
(2, 'Imagine Dragons', 'banda perrona de rock y pop');
...
INSERT INTO `canciones` (`id`, `Cancion`, `genero_id`, `Duracion`, `Fecha`, `Activo`, `Foto`) VALUES
(1, 'Radioactive', 1, '03:06:00', '2029-10-12', 1, 'https://www.billboard.com/wp-content/uploads/media/Imagine-Dragons-Radioactive-screenshot-2019-billb');
...
INSERT INTO `membresias` (`id`, `Descp`, `Precio`) VALUES
(1, 'Gratis\r\nMusica casi ilimitada, con anuncios', 0),
(2, 'Premium individual\r\nMusica ilimitada incluso sin conexion, y sin anuncios', 139);
...
CREATE TABLE `playlist` (
  ...
  `usuarios_id` int(11) NOT NULL,
  `duracion` time NOT NULL,
  `dura_tota_canc` int(11) NOT NULL,
...
ALTER TABLE `playlists_canciones`
  ...
  ADD CONSTRAINT `playlists_canciones_ibfk_2` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`id`),
